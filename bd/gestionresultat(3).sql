...
--
-- Hôte : localhost
-- Généré le :  mer. 22 juin 2022 à 07:30
...
INSERT INTO `fichier` (`id`, `libelle`, `id_expediteur`, `id_filiere`, `date`) VALUES
(1, 'ASICNAM.pdf', '10', 4, '2022-06-22');
...
('azerty', '$2y$10$ELI9wGFk/F2eVFwFtr5FKudUByIudmA4JYMm/EknzKpys.h6z9VI.', 'A1'),
...
('INF110', 'ComplexitÃ©', 1, ''),
('INFO111', 'Algorithmique et programmation en C', 1, '0'),
...
--
-- Structure de la table `new_file`
--
...
--
-- Déchargement des données de la table `new_file`
--

INSERT INTO `new_file` (`id`) VALUES
(1);
...
('A11', 'Nkuimi', 'Jules', 'nkuimi@fasciences.co', 'ens', 2),
('A12', 'TIOMO', 'Gustave', 'gustave@gmail.com', 'ens', 2),
('A1', 'TAMO', 'Karl', 'tamo@gmail.com', 'scl', 0),
('I2', 'TOKO', 'Brice', 'toko@gmail.com', 'ci', 0);
