...
<head>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>Sysco </title>    <link rel="stylesheet" href="css/style.css">
...
<input type="hidden" name="" id="id_dest" value="<?php echo $_SESSION['matricule'];?>">
            ...
            <nav><h6></h6>
                ...
                <div class="container py-0 h-60 " style="margin-left:8%;">
                        <div class="text-center text-lg-start mt-2 pt-2">
                                <a href="upload.php" class="btn btn-success btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;">Envoyer des PVs</a>
    ...
    <div class="part_right">
        ...
        <div class="body">
            <div id="title" class="bloc_title" style="height:45px">Nouvelles notes reçues</div>
    ...
    <script src="js1/notes2.js"></script>
