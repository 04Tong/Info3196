...
?>
                ...
                <div class="container py-0 h-60 " style="margin-left:8%;">
                        <div class="text-center text-lg-start mt-2 pt-2">
                                <a href="upload.html" class="btn btn-success btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;">Envoyer des fichiers</a>
    ...
    <div class="part_right">
        ...
        <div class="body">
            <div id="title" class="bloc_title">Envoyer des fichiers</div>
