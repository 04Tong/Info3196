...
var select_type=document.getElementById('select_type_note');
    ...
    success: function(reponse2) {
        ...
        //alert(documents[i2])
         for (let i2 = 0; i2 < documents.length; i2++) {
             var a=documents[i2].split('.')
             //alert(a)
             var type=a[1];
            
             if(type=='pdf'){
                tableau.innerHTML+=" <tr> <td><img src='../images/icon-pdf.png' style='transform:scale(.7) translateY(-20px);position:absolute;'></td> <td><a href='../client/files1/"+documents[i2]+"'>"+documents[i2]+"</a></td> <td></td> <td><div class='container  ' style='margin-left:10%;'>         <div class='text-center text-lg-start '> <a href='../client/files1/"+documents[i2]+"' class='btn btn-success btn-lg'><i class='fa fa-download'></i> Télécharger</a>                 </div></td></td></tr>";
                    ...
                    tableau.innerHTML+=" <tr> <td><img src='../images/word-icon-png.png' style='transform:scale(.7) translateY(-10px);position:absolute;'></td> <td><a href='../client/files1/"+documents[i2]+"'>"+documents[i2]+"</a></td> <td></td> <td><div class='container  ' style='margin-left:10%;'>         <div class='text-center text-lg-start '> <a href='../client/files1/"+documents[i2]+"' class='btn btn-success btn-lg'><i class='fa fa-download'></i> Télécharger</a>                 </div></td></td></tr>";
