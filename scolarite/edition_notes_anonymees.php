...
<body>
            ...
            <nav><h6>Administration de compte utilisateur</h6>
                <ul id="menu"> 
                    <li>
                        ...
                        <ul>                            
                            ...
                            <li id=""> <a href="pv_recus.html">PVs reçus</a> </li>
                ...
                <div class="container py-0 h-60 " style="margin-left:8%;">
                    ...
                    <div class="text-center text-lg-start mt-2 pt-1">
                        <button class="btn btn-primary btn-lg" style="padding-left: 0.3rem; padding-right: 0.3rem;">
    ...
    <div class="part_right">
        ...
        <div class="body">
            <div id="title" class="bloc_title">Edition des notes anonymées</div>
