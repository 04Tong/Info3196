...
<input type="hidden" name="" id="id_exp" value="<?php echo $_SESSION['matricule'];?>">
                    </p>
            ...
            <nav><h6></h6>
                <ul id="menu"> 
                    <li>
                        ...
                        <ul>                            
                            <li id=""><a href="                    notes_envoyees.php">Fichiers envoyés</a> </li>
                ...
                <div class="container py-0 h-60 " style="margin-left:8%;">
                        <div class="text-center text-lg-start mt-2 pt-2">
                                <a href="upload.php" class="btn btn-success btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;">Envoyer des fichiers</a>
    ...
    <div class="part_right">
        ...
        <div class="body">
            <div id="title" class="bloc_title" style="height:45px">Notes envoyées</div>
    ...
    <script src="js1/notes.js"></script>
