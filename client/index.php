    ...
    <div class="part_left">
        ...
        <div class="body">
            <nav><h6></h6>
                ...
                <div class="container py-0 h-60 " style="margin-left:1%;">
                        <div class="text-center text-lg-start mt-2 pt-2">
                                <a href="upload.php" class="btn btn-success btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;">Envoyer fichier anonymats</a>
    ...
    <div class="part_right">
        <div class="head">
                <ol class="liste1">
                    ...
                    <li class="titre">SYSTEME DE COLLECTE DE NOTES</li>
                </ol>
                <ol class="liste2">
        ...
        <div class="body">
            ...
            <div id="main_stats" class="main_stats"><a href="nouveaux_pv_recus.php">
                ...
                </div></a> <a href="notes_envoyees.php">
                <div id="bloc2" class="bloc2">
                    ...
                    //Fonction qui charge les départements
                    $requete= "SELECT COUNT(id) As nb FROM note";
                    foreach ($bdd->query($requete) as $row) {
                        # code...
                        $note=$row['nb'];
